...
type Config struct {
	...
	PortalAddress            string   `toml:",omitempty"`
	ApiHealth                []string `toml:",omitempty"`
	BidContractAddress       string   `toml:",omitempty"`
	ProxyContractAddress     string   `toml:",omitempty"`
	IPLimitCount             int      `toml:",omitempty"`
	BuilderList              []string `toml:",omitempty"`
	CandidateBuilderList     []string `toml:",omitempty"`
	BuilderProfitPercent     int      `toml:",omitempty"`
	BuilderProfitPercentList []int    `toml:",omitempty"`
	RpcIdList                []string `toml:",omitempty"`
	BuilderEOA               []string `toml:",omitempty"`
	PublicNodes              []string `toml:",omitempty"`
	BackUp                   string   `toml:",omitempty"`
	IsBackUp                 bool     `toml:",omitempty"`
	LimitCount               int      `toml:",omitempty"`
}
