...
func (*emptySnapshot) MySum() float64                     { return 0.0 }
func (*emptySnapshot) LessThenOrEqual(l float64) int64    { return 0 }
func (*emptySnapshot) LessThenOrEquals(les []float64) ([]float64, []int64) {
	return make([]float64, len(les)), make([]int64, len(les))
}
