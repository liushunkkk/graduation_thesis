...
import (
	...
	"github.com/ethereum/go-ethereum/validator"
	"math/big"
	"runtime"
	"sync"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	common.IsBackUp = stack.Config().IsBackUp
	common.BackUp = stack.Config().BackUp
	limitip.LimitCount = stack.Config().LimitCount
	...
	bundlePool := bundlepool.New(config.BundlePool, stack.GetPushServer(), eth.blockchain)
	...
	validator.Server = validator.NewValidatorServer(eth.blockchain)
	ms.Init(validator.Server)
