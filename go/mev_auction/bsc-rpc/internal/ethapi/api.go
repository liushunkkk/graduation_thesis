...
func (s *BlockChainAPI) Call(ctx context.Context, args TransactionArgs, blockNrOrHash *rpc.BlockNumberOrHash, overrides *StateOverride, blockOverrides *BlockOverrides) (hexutil.Bytes, error) {
	// ourself rpc magic value
	if args.To != nil && args.To.String() == "0x0000000000000000000000000000000000000100" && args.Value != nil && args.Value.String() == "0x64" {
		return []byte{0x64}, nil
	}
	// pretend 48club rpc magic value
	if args.To != nil && args.To.String() == "0x0000000000000000000000000000000000000048" && args.Value != nil && args.Value.String() == "0x30" {
...
func (s *TransactionAPI) GetTransactionReceipt(ctx context.Context, hash common.Hash) (map[string]interface{}, error) {
	...
	if !found {
		if invalid_tx.Server.Get(hash) != nil {
			return map[string]interface{}{
				"status":            hexutil.Uint64(types.ReceiptStatusFailed),
				"cumulativeGasUsed": hexutil.Uint64(uint64(0)),
				"logsBloom":         types.Bloom{},
				"logs":              []*types.Log{},
				"transactionHash":   common.Hash{},
				"gasUsed":           hexutil.Uint64(uint64(0)),
			}, nil
		}
