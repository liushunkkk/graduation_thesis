...
require (
	...
	github.com/zeromicro/go-zero v1.7.2 // indirect
...
replace (
	...
	github.com/prysmaticlabs/prysm/v5 v5.0.3 => gitlab.com/shengweifeng/prysm/v5 v5.0.3-relaese
