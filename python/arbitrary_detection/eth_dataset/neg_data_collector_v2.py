...
df_neg.to_csv("../files/test_eth_negative_data.csv", index=False, encoding="utf-8")
print(f"已保存负样本至 ../files/test_eth_negative_data.csv，共 {len(df_neg)} 条记录。")
